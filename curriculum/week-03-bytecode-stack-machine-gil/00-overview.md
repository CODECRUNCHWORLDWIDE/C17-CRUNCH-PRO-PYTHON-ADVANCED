...
| [resources.md](./01-resources.md) | CPython source pointers, PEPs, devguide |
| [lecture-notes/01-the-evaluation-loop-deep-dive.md](./02-lecture-notes/01-the-evaluation-loop-deep-dive.md) | `_PyEval_EvalFrameDefault`, dispatch, the value stack, frames |
| [lecture-notes/02-load-fast-vs-load-global-and-specialization.md](./02-lecture-notes/02-load-fast-vs-load-global-and-specialization.md) | Name-resolution cost; PEP 659 adaptive specialization |
| [lecture-notes/03-the-GIL-and-the-free-threaded-build.md](./02-lecture-notes/03-the-GIL-and-the-free-threaded-build.md) | `take_gil`/`drop_gil`, PEP 703, subinterpreters |
| [exercises/README.md](./03-exercises/00-overview.md) | Index |
| [exercises/exercise-01-bytecode-tracer.py](./03-exercises/exercise-01-bytecode-tracer.py) | Print each instruction as code runs |
| [exercises/exercise-02-specialization-observed.py](./03-exercises/exercise-02-specialization-observed.py) | Watch a `BINARY_OP` specialize and deoptimize |
| [exercises/exercise-03-GIL-vs-threads.py](./03-exercises/exercise-03-GIL-vs-threads.py) | Measure thread scaling under the GIL |
| [challenges/README.md](./04-challenges/00-overview.md) | Stretch challenge |
| [challenges/challenge-01-write-a-100-line-tracer.md](./04-challenges/challenge-01-write-a-100-line-tracer.md) | Build the mini-project's tracer from scratch in one sitting |
| [quiz.md](./05-quiz.md) | 10 MCQ |
| [homework.md](./06-homework.md) | Six problems (~6h) |
| [mini-project/README.md](./07-mini-project/00-overview.md) | The 100-line bytecode tracer |
