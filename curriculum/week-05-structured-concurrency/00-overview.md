...
| [resources.md](./01-resources.md) | Trio docs, anyio docs, PEP 654, asyncio source pointers, Nathaniel J. Smith's essay |
| [lecture-notes/01-nurseries-task-groups-and-structured-cancellation.md](./02-lecture-notes/01-nurseries-task-groups-and-structured-cancellation.md) | Smith's rule, Trio nurseries vs. asyncio `TaskGroup`, ExceptionGroup, the implementation of `__aexit__` |
| [lecture-notes/02-timeouts-shield-and-cancellation-semantics.md](./02-lecture-notes/02-timeouts-shield-and-cancellation-semantics.md) | `asyncio.timeout`, `shield`, `wait_for`, `Task.uncancel`, the cancellation state machine in 3.11+ |
| [lecture-notes/03-back-pressure-with-bounded-queues.md](./02-lecture-notes/03-back-pressure-with-bounded-queues.md) | `asyncio.Queue`, `Semaphore`, async iterators, the producer/consumer pipeline, sentinels and `Queue.shutdown` |
| [exercises/README.md](./03-exercises/00-overview.md) | Index |
| [exercises/exercise-01-taskgroup-with-cancel.py](./03-exercises/exercise-01-taskgroup-with-cancel.py) | TaskGroup with one child cancelled mid-flight; verify sibling cancellation and `finally` ordering |
| [exercises/exercise-02-timeout-and-shield.py](./03-exercises/exercise-02-timeout-and-shield.py) | Nested `asyncio.timeout`; `shield` around a critical write; observe `uncancel` |
| [exercises/exercise-03-bounded-queue-fan-out.py](./03-exercises/exercise-03-bounded-queue-fan-out.py) | One producer, N consumers, `Queue(maxsize=K)`; watch the producer park when consumers stall |
| [challenges/README.md](./04-challenges/00-overview.md) | Stretch challenge |
| [challenges/challenge-01-async-crawler-with-cancellation.md](./04-challenges/challenge-01-async-crawler-with-cancellation.md) | A small crawler skeleton that exercises every primitive in one timed sitting (~3h) |
| [quiz.md](./05-quiz.md) | 10 MCQ |
| [homework.md](./06-homework.md) | Six problems (~6h) |
| [mini-project/README.md](./07-mini-project/00-overview.md) | A robust async web crawler with cancellation + back-pressure |
