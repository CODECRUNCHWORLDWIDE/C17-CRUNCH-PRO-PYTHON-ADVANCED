...
Push to GitHub. Paste the URL into `c17-week-05-submission.md` in your portfolio repo with one sentence on what you would do next if you had another day. (Most learners answer: "implement the distributed-frontier stretch goal" or "add a small `rich` TUI showing live progress.")
