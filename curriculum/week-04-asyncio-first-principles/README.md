...
| [resources.md](./resources.md) | `asyncio` source pointers, PEPs, devguide, Trio readings |
| [lecture-notes/01-coroutines-vs-generators.md](./lecture-notes/01-coroutines-vs-generators.md) | `async def`, `await`, awaitables, bytecode for both, PEP 492 |
| [lecture-notes/02-the-event-loop-build-your-own.md](./lecture-notes/02-the-event-loop-build-your-own.md) | Runnable queue, timer heap, selector poll, the `_run_once` step |
| [lecture-notes/03-tasks-futures-gather-taskgroup.md](./lecture-notes/03-tasks-futures-gather-taskgroup.md) | `Future` state machine, `Task.__step`, `gather`, `TaskGroup` (PEP 654) |
| [exercises/README.md](./exercises/README.md) | Index |
| [exercises/exercise-01-toy-event-loop.py](./exercises/exercise-01-toy-event-loop.py) | ~80-line event loop running two coroutines with sleep |
| [exercises/exercise-02-async-vs-thread-fetch.py](./exercises/exercise-02-async-vs-thread-fetch.py) | Fan-out: asyncio vs. ThreadPoolExecutor; measure memory and latency |
| [exercises/exercise-03-taskgroup-fan-out.py](./exercises/exercise-03-taskgroup-fan-out.py) | Real `asyncio.TaskGroup` with one failing child; observe ExceptionGroup |
| [challenges/README.md](./challenges/README.md) | Stretch challenge |
| [challenges/challenge-01-asyncio-clone.md](./challenges/challenge-01-asyncio-clone.md) | Build the mini-project's clone from scratch in one 4-hour sitting |
| [quiz.md](./quiz.md) | 10 MCQ |
| [homework.md](./homework.md) | Six problems (~6h) |
| [mini-project/README.md](./mini-project/README.md) | A toy `asyncio` clone: `sleep`, `gather`, `Task`, `run` |
