...
| [resources.md](./01-resources.md) | Curated readings + CPython source pointers |
| [lecture-notes/01-the-pyobject-struct-and-refcounts.md](./02-lecture-notes/01-the-pyobject-struct-and-refcounts.md) | The struct, INCREF/DECREF, where refcounts come from |
| [lecture-notes/02-cycles-and-the-generational-gc.md](./02-lecture-notes/02-cycles-and-the-generational-gc.md) | Why refcounting isn't enough; the GC's job |
| [lecture-notes/03-slots-weakref-and-tooling.md](./02-lecture-notes/03-slots-weakref-and-tooling.md) | `__slots__`, `weakref`, `tracemalloc`, `memray` |
| [exercises/README.md](./03-exercises/00-overview.md) | Index |
| [exercises/exercise-01-trace-refcounts.py](./03-exercises/exercise-01-trace-refcounts.py) | Watch refcounts move |
| [exercises/exercise-02-build-a-cycle.py](./03-exercises/exercise-02-build-a-cycle.py) | Build, detect, break a cycle |
| [exercises/exercise-03-slots-comparison.py](./03-exercises/exercise-03-slots-comparison.py) | Measure the `__slots__` memory win |
| [challenges/README.md](./04-challenges/00-overview.md) | Stretch challenges |
| [challenges/challenge-01-hunt-a-leak.md](./04-challenges/challenge-01-hunt-a-leak.md) | Real leak in a real codebase |
| [challenges/challenge-02-cache-without-keeping-alive.md](./04-challenges/challenge-02-cache-without-keeping-alive.md) | Design a leak-free cache |
| [quiz.md](./05-quiz.md) | 10 MCQ |
| [homework.md](./06-homework.md) | Six problems (~6h) |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Detect a leak in a small OSS project |
