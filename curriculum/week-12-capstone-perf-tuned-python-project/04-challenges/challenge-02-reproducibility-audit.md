...
1. **Pick a peer.** Another student in the course is ideal. If you cannot find a peer, run the audit yourself on a clean Docker container or a borrowed machine.
