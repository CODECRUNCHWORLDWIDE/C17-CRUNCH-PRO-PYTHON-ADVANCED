...
```mermaid
flowchart TD
  T0["Tier 0 Naive baseline"] --> P0{"Meets criteria"}
  P0 -->|No| T1["Tier 1 Algorithmic improvement"]
  T1 --> P1{"Meets criteria"}
  P1 -->|No| T2["Tier 2 Vectorisation NumPy SciPy"]
  T2 --> P2{"Meets criteria"}
  P2 -->|No| T3["Tier 3 C extension"]
  T3 --> P3{"Meets criteria"}
  P3 -->|No| T4["Tier 4 Parallelisation"]
  P0 -->|Yes| Stop["Stop and write report"]
  P1 -->|Yes| Stop
  P2 -->|Yes| Stop
  P3 -->|Yes| Stop
  T4 --> Stop
```
*Walk the tier ladder in order, measuring after each rung, and stop as soon as the success criteria are met.*
