...
| [resources.md](./01-resources.md) | PEP 703, PEP 684, PEP 734, Sam Gross talks, the threading/asyncio/multiprocessing docs |
| [lecture-notes/01-threads-and-asyncio.md](./02-lecture-notes/01-threads-and-asyncio.md) | Threads and asyncio side by side. The GIL release rules. The event-loop blocking failure. PEP 3148, PEP 3156, PEP 492 |
| [lecture-notes/02-multiprocessing-and-the-pickling-tax.md](./02-lecture-notes/02-multiprocessing-and-the-pickling-tax.md) | Multiprocessing end-to-end. Start methods. Pickling. Shared memory. When the tax breaks the model |
| [lecture-notes/03-pep-703-and-pep-684-the-future.md](./02-lecture-notes/03-pep-703-and-pep-684-the-future.md) | The free-threaded build (PEP 703). Subinterpreters (PEP 684 / PEP 734). What changes in 3.15 |
| [exercises/exercise-01-thread-vs-asyncio.py](./03-exercises/exercise-01-thread-vs-asyncio.py) | Predict which is faster on three workloads; run it; explain the result |
| [exercises/exercise-02-gil-release-audit.py](./03-exercises/exercise-02-gil-release-audit.py) | Probe which C-extension calls release the GIL; build the audit table |
| [exercises/exercise-03-multiprocessing-pickle-tax.py](./03-exercises/exercise-03-multiprocessing-pickle-tax.py) | Measure the pickling tax on three argument shapes; report the percentage |
| [exercises/exercise-04-asyncio-blocking-event-loop.py](./03-exercises/exercise-04-asyncio-blocking-event-loop.py) | Reproduce the canonical "blocked event loop" bug; fix it three different ways |
| [exercises/SOLUTIONS.md](./03-exercises/SOLUTIONS.md) | Expected outputs, common errors, the reasoning behind each exercise |
| [challenges/challenge-01-free-threaded-audit.md](./04-challenges/challenge-01-free-threaded-audit.md) | Install the free-threaded build; rerun the benchmark; identify any C extension that breaks |
| [challenges/challenge-02-subinterpreter-pipeline.md](./04-challenges/challenge-02-subinterpreter-pipeline.md) | Build a three-stage pipeline using `interpreters.Queue`; benchmark against a process pool |
| [quiz.md](./05-quiz.md) | 10 MCQ |
| [homework.md](./06-homework.md) | Six problems (~7h) |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Build the document scorer five ways; benchmark; write the decision tree |
| [mini-project/decision-tree.md](./07-mini-project/decision-tree.md) | The reference decision tree (read after attempting your own) |
